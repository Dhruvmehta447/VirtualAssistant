...
// // }, []);
// useEffect(() => {
//   // ✅ Fix: Cross-browser compatibility for SpeechRecognition constructor
//   const SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition; // ✅ Added fallback for Chrome support
...
//   const recognition = new SpeechRecognition(); // ✅ Proper usage after checking support
...
//       <div className='w-full h-[400px] gap-[20px] overflow-y-auto flex flex-col truncate'>
//         {userData.history?.map((his, index) => ( // ✅ Added index as key for each history item
//           <div key={index} className='text-gray-200 text-[18px] w-full h-[30px]'> {/* ✅ Added key={index} */}
//             {his}
//           </div>
//         ))}
//       </div>
